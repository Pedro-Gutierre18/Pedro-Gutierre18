...
[![Portfolio](https://img.shields.io/badge/Portfolio-111827?style=flat&logo=vercel&logoColor=white)](https://pedrogutierre.vercel.app/)

**Profissional em transição para Engenharia de Dados**  
Graduação em Gestão de Tecnologia da Informação · Pós em Engenharia de Software
...
Trabalho com dados em ambiente hospitalar — cadastros de materiais, procedimentos cirúrgicos e fluxos de importação — e uso esse contexto real como motor para aprender e construir.

Meu foco atual é construir uma base sólida em Engenharia de Dados: pipelines, automações e visualizações que resolvem problemas concretos. Cada projeto aqui tem origem em um problema real que eu quis resolver com código.
...
`ETL` `Automação` `Data Cleaning` `Dashboards` `Storytelling com Dados` `Web Scraping`
